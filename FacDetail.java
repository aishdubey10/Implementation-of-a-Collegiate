...
String s="<table align='center' width='70%'  border='0' cellspacing='0' cellpadding='0'><tr><th height='30' bgcolor= '' width='20%' scope='col'><div align='center'>DEPARTMENT</div></th><th bgcolor= '' width='20%' scope='col'><div align='center'>FACULTY</div></th><th bgcolor= '' width='20%'scope='col'><div align='center'>ADDRESS</div></th><th bgcolor= '' width='20%' scope='col'><div align='center'>CONTECT NO.</div></th><th bgcolor= '' width='20%' scope='col'><div align='center'>MAIL ID</div></th><th bgcolor= '' scope='col'><div align='center'>SEX</div></th></tr>";
     while(rs.next())
  {
dep=rs.getString(2);
      i++;
