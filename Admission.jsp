...
<table width="100%" height="406"  border="1" cellpadding="1" cellspacing="1" background="images/index_07-081.jpg">
  ...
  <tr>
    <td width="52%" height="277"><form name="form1" method="" action="Submitfm.jsp?name=coll" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="imgf" type="image" onClick="return validationTxt()" src="images/titleimage1.jpg" width="165" height="151" border="0">      
        <select name=select><option value=0></option><%obj.option();%>
      </select> 
      <span class="style4 style6">COLLEGE'S</span>
                    </form></td>
    <td width="48%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Submitfm.jsp?name=uni"><img src="images/VCComp8.jpg" width="188" height="150" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4 style6">UNIVERSITY </span></td>
  </tr>
</table>
